...
var Video = /** @class */ (function (_super) {
    ...
    Video.prototype.render = function () {
        var combinedStyles = extend(RX.Styles.combine(this.props.style), {
            display: 'flex'
        });
        ...
        return (React.createElement("video", { ref: 'video', style: combinedStyles, src: this.props.source, controls: this.props.showControls, loop: this.props.loop, onLoadedData: this._onLoadedData, onError: this.props.onError, onEnded: this.props.onEnded, onLoadStart: this.props.onLoadStart, onCanPlay: this.props.onCanPlay, onCanPlayThrough: this.props.onCanPlayThrough, onTimeUpdate: this.props.onProgress ? this._onTimeUpdate : null }));
    };
