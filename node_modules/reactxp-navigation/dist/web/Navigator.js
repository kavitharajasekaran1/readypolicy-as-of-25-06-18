...
var NavigatorImpl = /** @class */ (function (_super) {
    ...
    NavigatorImpl.prototype.render = function () {
        ...
        return (React.createElement(reactxp_1.View, { key: 'container', style: _styles.container },
            React.createElement(reactxp_1.View, { style: _styles.transitioner, ref: 'transitioner' }, scenes)));
    };
    ...
    NavigatorImpl.prototype._renderNavigatorScene = function (route, index) {
        ...
        return (React.createElement(reactxp_1.View, { key: 'scene_' + this._getRouteID(route), ref: 'scene_' + index, style: styles }, this.props.renderScene(route)));
    };
    ...
    NavigatorImpl.prototype._enableScene = function (sceneIndex) {
        var sceneStyle = reactxp_1.Styles.combine([_styles.baseScene, _styles.sceneStyle, _styles.defaultSceneStyle]);
