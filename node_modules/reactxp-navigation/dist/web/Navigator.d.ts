...
import { Navigator as NavigatorBase, NavigatorDelegateSelector as DelegateSelector, NavigatorProps, NavigatorState as BaseNavigatorState } from '../common/Types';
...
export declare class NavigatorImpl extends NavigatorBase<NavigatorState> {
    ...
    private _enableScene(sceneIndex, force?);
...
export declare const NavigatorDelegateSelector: DelegateSelector;
