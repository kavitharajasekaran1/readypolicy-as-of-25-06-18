...
var Picker = /** @class */ (function (_super) {
    ...
    Picker.prototype.render = function () {
        return (React.createElement("select", { style: this.props.style, value: this.props.selectedValue, onChange: this._onValueChange }, _.map(this.props.items, function (i, idx) { return React.createElement("option", { value: i.value, key: idx }, i.label); })));
    };
    return Picker;
}(RX.Picker));
