...
export declare class Button extends React.Component<Types.ButtonProps, {}> {
    static propTypes: {
        children: PropTypes.Requireable<any> & PropTypes.Validator<any>;
    };
    static contextTypes: {
    ...
    touchableHandleActivePressIn: (e: React.SyntheticEvent<any>) => void;
    touchableHandleActivePressOut: (e: React.SyntheticEvent<any>) => void;
    touchableHandlePress: (e: React.MouseEvent<any>) => void;
    touchableHandleLongPress: (e: React.MouseEvent<any>) => void;
