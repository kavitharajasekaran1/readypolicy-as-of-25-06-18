...
var Link = /** @class */ (function (_super) {
    ...
    Link.prototype.render = function () {
        return (React.createElement(RN.Text, { style: this.props.style, ref: 'nativeLink', numberOfLines: this.props.numberOfLines === 0 ? undefined : this.props.numberOfLines, onPress: this._onPress, onLongPress: this._onLongPress, allowFontScaling: this.props.allowFontScaling, maxContentSizeMultiplier: this.props.maxContentSizeMultiplier }, this.props.children));
    };
    return Link;
}(React.Component));
exports.Link = Link;
